 ...
 * and two meaning it came from the wiki file. Hadoop sent these to this particular node. The method iterates over
 ...
 * of times that the particular name was found in the wiki file. Then, assuming that inPeople is true,
 * the reducer writes out a pair of (NullWritable, Text) where the text is a string that I built with the number of 
 * times the name was counted (assuming > 0), and then the key (the name) is concatenated.
 */
